    ...
    public static List<Route> findRoute(int orNode, int deNode, TopologyManager topology, final int K) {
        ...
        for (int k = 1; k < K; k++) { // repete até encontrar K caminhos
            ...
            for (int i = 0; i < routePath.size() - 1; i++) { // para cada nó no caminho anterior, exceto o destino
                ...
                Route rootRoute = YEN2.createSubRoute(previousRoute, 0, i, topology);
                ...
                for (Route r : routesYEN) { 
                    ...
                    if(i < r.getNumNodes()){
                        ...
                        shortestRoute = YEN2.createSubRoute(r, 0, i, topology);

                        if (YEN2.checkPathEquals(rootRoute.getPath(), shortestRoute.getPath())){ 
                ...
                if (spurPath != null) {
                    Route totalRoute = YEN2.mergeRoute(rootRoute, spurPath, topology); 
